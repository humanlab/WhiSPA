...
"""
python sql/fill_table.py -c ~/.my.cnf -t "feat\$sbert384\$wtc_seg_outcomes\$user_id" --csv /cronus_data/rrao/WhiSBERT/embeddings/wtc_all-MiniLM-L12-v2.csv
python sql/fill_table.py -c ~/.my.cnf -t "feat\$sbert384\$hitop_seg_outcomes\$user_id" --csv /cronus_data/rrao/WhiSBERT/embeddings/hitop_all-MiniLM-L12-v2.csv
"""
